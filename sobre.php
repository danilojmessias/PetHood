    ...
    <div class="container vago">
        <div class="content-vago">
            ...
            <div class="titulo">
                <div class='row justify-content-center'>
                    <div class='col-8 mt-4 mb-4'>
                        <h1 class='text-center p-2'>Sobre</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="conteudo-vago">
                <div class='row justify-content-center'>
                    <div class="col-4">
                        <h3 class="text-end">Titulo exemplo</h3>
                        <p class="text-end">Duis vel lorem id purus fringilla vulputate. Donec porttitor, odio in
                            pellentesque
